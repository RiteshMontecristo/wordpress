...
function countrySelector($value = '')
{
    global $countryArray;
    ...
    foreach ($countryArray as $code => $country) {
        ...
        if ($countryName === $value) {
            continue; // Skip the current value if it matches the selected one
        }
...
{
    global $countryArray;
    $output = " <select name='code' id='code' >";
    $output .= "<option value='' selected></option>";

    foreach ($countryArray as $code => $country) {
        $countryCode = "+" . $country["code"];
        $output .= "<option value='$countryCode'>$countryCode</option>";
    }
